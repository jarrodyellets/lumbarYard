		...
		<div className={props.sticky ? "nav-bar sticky" : "nav-bar"} id="nav-bar" aria-label="nav bar">
			...
			<div className="linksWrapper">
				<div className="linksDiv" id="linksDiv">
					...
					<a href="#products" className="links hover" onClick={()=> {props.handlePage("mattresses")}}>Mattresses</a>
					<a href="#about" className="links aboutLink hover" onClick={()=> {props.handlePage("about")}}>About</a>
					<a href="#contact" className="links contactLink hover" onClick={()=> {props.handlePage("contact")}}>Contact</a>
				</div>
