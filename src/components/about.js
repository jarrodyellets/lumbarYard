...
const About = (props) => {
	return (
		<div className="aboutWrapper">
			...
			a good nights rest.  Nowadays, sleep is taken for granted, when it should be the focal point of a healthy lifestyle.  The quality of your
			...
			a well manufactored mattress.  After moving to New York, I soom realized that I was not happy with the quality of mattresses that were available.
			...
			started with the philosphy that a good mattress needs to be properly calibrated to support the back, yet feel comfortable at the same time.  The
			...
			<br />
			<div>Todd Gack opened The Lumbar Yard out of his Brooklyn Studio apartment in 1997.  After being open for 3 years, he quickly realized he need a bigger
			space if he wanted to The Lumbar Yard to grow.  In 2000, he opened the current location in the Upper West side of Manhatten.   
			</div>
		</div>
		)
}
